...
- スライディング状態からジャンプした際、身長切替で即着地してしまう不具合を修正しました。
- キャラクター描画Y座標を物理座標 `player.y` に直接追従させています。
- 強化選択UIを、3枚の大きなオーグメントカードから1つ選ぶ形式へ刷新しました。
- カードにはレア度表示、現在の次Lv、トランプ・紅茶・時計モチーフを追加し、童話のティーパーティー風にしています。


## ビジュアル刷新

- ドット絵寄りの背景・敵キャラから、**ミニキャラ風のやわらかいビジュアル**へ変更しました。
- 操作キャラは既存の白うさぎメイドのまま維持し、敵・背景・UIだけをかわいいティーパーティー風へ寄せています。
- 背景はティーポットハウス、やわらかいお城、サインポスト、うさぎ気球などを追加しています。
